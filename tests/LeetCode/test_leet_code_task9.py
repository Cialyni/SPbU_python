...
@pytest.mark.parametrize(
    ...
    (
            ...
            ([5,4,5,1,1,None,5], 2),
            ([], 0),
            ([1,2,43,2,34,2,423,None,1,1,2,2,None,None,None,None,None,3,4,5,66,7,8,5,3,3,4,6,7,8], 1),
            ([5,4,5,1,1,None,5,5,5,5,None,None,5,5,5,1,1,3,4,5,5,5,5], 3),
            ([1,1,1,1,None,None,1,1,None,None,None,None,1,11,1,1,1,1,None,None,None,None,None,None,None,None,None,None,None,1], 8),
